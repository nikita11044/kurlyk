...
const KurlykContentWrapper = styled(Paper)({
    padding: '10px 15px',
    cursor: 'pointer',
    '&:hover': {
...
export const Kurlyk: React.FC<KurlykProps> = ({text, user}): React.ReactElement => {
    return <KurlykContentWrapper square variant='outlined'>
